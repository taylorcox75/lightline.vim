" ============================================================================= j" Filename: autoload/lightline/colorscheme/jellybeans.vim
" Author: itchyny
" License: MIT License
...
let s:p.normal.left = [ [ s:base2, s:darkred ], [ s:base3, s:base01 ] ]
let s:p.normal.right = [ [ s:base02, s:base00 ], [ s:base2, s:base01 ] ]
